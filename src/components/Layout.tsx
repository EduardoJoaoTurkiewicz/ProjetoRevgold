...
const Layout: React.FC<LayoutProps> = ({ children, currentPage, onPageChange }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50/30 to-emerald-50/50 flex">
      {/* Sidebar */}
      <div className="w-80 bg-gradient-to-b from-slate-800 via-green-900 to-emerald-900 shadow-2xl relative overflow-hidden z-40 revgold-sidebar">
        {/* Background Effects */}
        ...
        {/* Header */}
        <div className="relative z-50 p-8 border-b border-green-700/30">
        ...
        {/* Navigation */}
        <nav className="relative z-50 mt-8 px-4" role="navigation">
          {menuItems.map((item) => {
      ...
      <div className="flex-1 flex flex-col">
        <header className="bg-white/80 backdrop-blur-xl border-b border-green-100/50 shadow-lg relative z-30 revgold-header">
