      ...
      <div className="card modern-shadow-xl">
        ...
        {salesWithBoletos.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-green-500 mb-4 text-xl font-medium">Nenhuma venda com boletos ainda.</p>
      ...
      <div className="card modern-shadow-xl">
        ...
        {debtsWithBoletos.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-green-600 font-medium">Nenhuma venda com boletos</p>
            <p className="text-green-500 text-sm mt-2">
              Boletos de vendas aparecerão aqui
            </p>
          </div>
        )}
      </div>
