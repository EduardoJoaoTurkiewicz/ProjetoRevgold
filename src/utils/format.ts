...
import { safeNumber, safeCurrency, safeAdd, safeSubtract } from '../utils/numberUtils';
...
export function Employees() {
  ...
  const calculateEmployeePayroll = (employeeId: string) => {
    ...
    // Salário base
    const baseSalary = safeNumber(employee.salary, 0);
    ...
    // Total a pagar
    const totalToPay = safeAdd(baseSalary, totalCommissions, totalOvertimes) - totalAdvances;
